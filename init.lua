...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local parser_languages = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc' }
      local ts_filetypes = { 'sh', 'bash', 'c', 'diff', 'html', 'lua', 'markdown', 'vim', 'help' }

      local missing = vim.tbl_filter(function(lang)
        return vim.tbl_isempty(vim.api.nvim_get_runtime_file('parser/' .. lang .. '.so', true))
